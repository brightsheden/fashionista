"""
Django settings for fashionflare project.
...
SECRET_KEY = 'ntfjmrx+6z@_564pa4k+%u7b9zw3g0y_!^_!#b(d4#scfhqfgl'
...
ROOT_URLCONF = 'fashionflare.urls'
...
WSGI_APPLICATION = 'fashionflare.wsgi.application'
